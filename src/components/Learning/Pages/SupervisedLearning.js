...
ax.scatter(X, y, color='#ffd700', label='Actual Data', s=100, alpha=0.8)
ax.plot(X, y_pred, color='#c5a861', label='Linear Regression', linewidth=2)

# Customize the plot
ax.set_xlabel('X', fontsize=12, color='#c5a861')
ax.set_ylabel('y', fontsize=12, color='#c5a861')
ax.set_title('Linear Regression Results', fontsize=14, pad=20, color='#ffd700')
...
for i in range(len(X)):
    color = '#ffd700' if y[i] == 0 else '#c5a861'
...
ax.set_title('SVM Classification Results', fontsize=14, pad=20, color='#ffd700')
...
ax.set_xlabel('Feature 1', fontsize=12, color='#c5a861')
ax.set_ylabel('Feature 2', fontsize=12, color='#c5a861')
ax.set_title(f'KNN Classification (k=${knnK})', fontsize=14, pad=20, color='#ffd700')
...
bars = ax.bar(features, feature_importance, color='#ffd700', alpha=0.8)

# Customize the plot
ax.set_xlabel('Features', fontsize=12, color='#c5a861')
ax.set_ylabel('Importance', fontsize=12, color='#c5a861')
ax.set_title(f'Decision Tree Feature Importance (Depth=${treeDepth})', fontsize=14, pad=20, color='#ffd700')
...
ax.set_xlabel('Features', fontsize=12, color='#c5a861')
ax.set_ylabel('Importance', fontsize=12, color='#c5a861')
ax.set_title(f'Random Forest Feature Importance (Trees=${forestSize})', fontsize=14, pad=20, color='#ffd700')
...
ax.set_xlabel('Feature 1', fontsize=12, color='#c5a861')
ax.set_ylabel('Feature 2', fontsize=12, color='#c5a861')
ax.set_title('Naive Bayes Classification', fontsize=14, pad=20, color='#ffd700')
...
fig.suptitle('Neural Network Results', fontsize=14, color='#ffd700', y=1.05)

# Plot training loss
ax1.set_facecolor('#2e261a')
ax1.plot(losses, color='#ffd700', linewidth=2)
ax1.set_xlabel('Epoch', fontsize=12, color='#c5a861')
ax1.set_ylabel('Loss', fontsize=12, color='#c5a861')
ax1.set_title('Training Loss', fontsize=12, color='#ffd700')
...
ax2.contourf(xx, yy, grid_predictions, alpha=0.3, colors=['#ffd700', '#c5a861'])
ax2.scatter(X[y==0, 0], X[y==0, 1], color='#ffd700', label='Class 0', alpha=0.8)
...
ax2.set_title('Decision Boundary', fontsize=12, color='#ffd700')
